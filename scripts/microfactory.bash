...
function soong_build_go
{
    BUILDDIR=$(getoutdir) \
      ...
      EXTRA_ARGS="-pkg-path android/soong=${TOP}/build/soong -pkg-path aosp/soong=${TOP}/vendor/aosp/build/soong -pkg-path prebuilts/bazel/common/proto=${TOP}/prebuilts/bazel/common/proto -pkg-path rbcrun=${TOP}/build/make/tools/rbcrun -pkg-path google.golang.org/protobuf=${TOP}/external/golang-protobuf -pkg-path go.starlark.net=${TOP}/external/starlark-go" \
      build_go $@
}
